...
var $author$project$Main$init = function (host) {
	return _Utils_Tuple2(
		{
			debouncer: $Gizra$elm_debouncer$Debouncer$Messages$toDebouncer(
				A2(
					$Gizra$elm_debouncer$Debouncer$Messages$settleWhenQuietFor,
					$elm$core$Maybe$Just(
						$Gizra$elm_debouncer$Debouncer$Messages$fromSeconds(1.5)),
					$Gizra$elm_debouncer$Debouncer$Messages$manual)),
			formula: $elm$core$Maybe$Nothing,
			host: host,
			initialPoint: $elm$core$Maybe$Nothing,
			nearestPoint: $elm$core$Maybe$Nothing,
			spinner: false
		},
...
var $author$project$Main$StopSpinner = {$: 'StopSpinner'};
var $author$project$Main$Variable = F2(
	function (a, b) {
		return {$: 'Variable', a: a, b: b};
	});
var $author$project$Main$Delay = function (a) {
	return {$: 'Delay', a: a};
};
...
var $author$project$Main$queryParam = function (variable) {
	var name = variable.a;
	var value = variable.b;
	return A2(
...
var $author$project$Main$queryResult = F2(
	function (inputstring, point) {
		if (point.$ === 'Nothing') {
			return A2(
				...
				_List_fromArray(
					[
						...
						$elm$url$Url$Builder$string,
						'formula',
						A2($elm$core$Maybe$withDefault, '', inputstring))
					]));
		} else {
			var p = point.a;
			return A2(
				...
				_Utils_ap(
					...
					A2($elm$core$List$map, $author$project$Main$queryParam, p)));
		}
	});
...
var $author$project$Main$pointDecoder = A2(
	...
	function (dict) {
		return $elm$json$Json$Decode$succeed(
			A2(
				...
				function (_var) {
					return A2(
						$author$project$Main$Variable,
						_var.a,
						A2(
							$elm$core$Maybe$withDefault,
							'',
							A2($elm$core$Maybe$map, $elm$core$String$fromFloat, _var.b)));
				},
...
var $author$project$Main$resultDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (s) {
		return (s === 'success') ? A2($elm$json$Json$Decode$field, 'result', $author$project$Main$pointDecoder) : A2(
			$elm$json$Json$Decode$field,
			'error',
			$elm$json$Json$Decode$fail('error'));
	},
	A2($elm$json$Json$Decode$field, 'status', $elm$json$Json$Decode$string));
var $author$project$Main$urlBase = function (host) {
		...
		return $elm$http$Http$get(
			{
				expect: A2(
					...
					A2(
						...
						$author$project$Main$GotResult,
						A2($elm$core$Basics$composeR, $Gizra$elm_debouncer$Debouncer$Messages$provideInput, $author$project$Main$Delay)),
					$author$project$Main$resultDecoder),
				url: _Utils_ap(
					$author$project$Main$urlBase(model.host),
					A2($author$project$Main$queryResult, model.formula, model.initialPoint))
			});
	} else {
		return $elm$core$Platform$Cmd$none;
	}
};
var $author$project$Main$GotVariables = function (a) {
	return {$: 'GotVariables', a: a};
};
var $author$project$Main$queryFormula = function (inputstring) {
	return A2(
		$elm$url$Url$Builder$absolute,
		_List_fromArray(
			['optimize']),
		_List_fromArray(
			[
				A2($elm$url$Url$Builder$string, 'formula', inputstring)
			]));
};
var $author$project$Main$getVariables = F2(
		...
		return $elm$http$Http$get(
			{
				expect: A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Main$GotVariables,
						A2($elm$core$Basics$composeR, $Gizra$elm_debouncer$Debouncer$Messages$provideInput, $author$project$Main$Delay)),
					$author$project$Main$resultDecoder),
				url: _Utils_ap(
					$author$project$Main$urlBase(model.host),
					$author$project$Main$queryFormula(inputstring))
			});
	});
...
var $author$project$Main$isFilled = function (point) {
	if (point.$ === 'Nothing') {
		return false;
	} else {
		var p = point.a;
...
var $author$project$Main$updateDebouncer = {
	...
	mapMsg: $author$project$Main$Delay,
	setDebouncer: F2(
		function (d, model) {
...
var $author$project$Main$updatePoint = F2(
	function (newpoint, point) {
		var existingvalues = $elm$core$Dict$fromList(
			A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2(
				...
				function (_var) {
					...
					return A2(
						...
						A2(
							$elm$core$Maybe$withDefault,
							'',
							A2($elm$core$Dict$get, k, existingvalues)));
				},
				newpoint));
	});
	...
	function (msg, model) {
		switch (msg.$) {
			case 'FormulaChanged':
				...
				var f = (!$elm$core$String$length(inputstring)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(inputstring);
				return _Utils_eq(f, $elm$core$Maybe$Nothing) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{formula: $elm$core$Maybe$Nothing, initialPoint: $elm$core$Maybe$Nothing, nearestPoint: $elm$core$Maybe$Nothing, spinner: false}),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{formula: f, spinner: true}),
					A2($author$project$Main$getVariables, model, inputstring));
			case 'InitialValueChanged':
				var name = msg.a;
				var value = msg.b;
				var newpoint = A2(
					$elm$core$Maybe$map,
					$elm$core$List$map(
						function (variable) {
							var n = variable.a;
							var v = variable.b;
							return _Utils_eq(name, n) ? A2($author$project$Main$Variable, name, value) : variable;
						}),
					model.initialPoint);
				return $author$project$Main$isFilled(newpoint) ? _Utils_Tuple2(
					_Utils_update(
						model,
					...
					$author$project$Main$getResult(
						_Utils_update(
							model,
							{initialPoint: newpoint, nearestPoint: $elm$core$Maybe$Nothing}))) : _Utils_Tuple2(
					_Utils_update(
						model,
						{initialPoint: newpoint, nearestPoint: $elm$core$Maybe$Nothing}),
					$elm$core$Platform$Cmd$none);
			case 'GotVariables':
				var result = msg.a;
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								initialPoint: A2($author$project$Main$updatePoint, point, model.initialPoint),
								nearestPoint: $elm$core$Maybe$Nothing
							}),
					...
					return _Utils_Tuple2(
						...
						A2(
							$elm$core$Task$perform,
							function (_v3) {
								return $author$project$Main$StopSpinner;
							},
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								nearestPoint: $elm$core$Maybe$Just(point)
							}),
						A2(
							$elm$core$Task$perform,
							function (_v5) {
			...
			case 'Delay':
				var subMsg = msg.a;
				var _v7 = A4($Gizra$elm_debouncer$Debouncer$Messages$update, $author$project$Main$update, $author$project$Main$updateDebouncer, subMsg, model);
				var m = _v7.a;
				var c = _v7.b;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Main$InitialValueChanged = F2(
	function (a, b) {
		return {$: 'InitialValueChanged', a: a, b: b};
	});
...
var $author$project$Main$inputValue = function (_var) {
	var name = _var.a;
	var value = _var.b;
	return A2(
			...
			]),
		{
			...
			onChange: $author$project$Main$InitialValueChanged(name),
...
var $author$project$Main$initialPoint = function (model) {
	return A2(
		...
		function () {
			if (model.spinner && (!$author$project$Main$isFilled(model.initialPoint))) {
				return _List_fromArray(
					[
						A2(
						$mdgriffith$elm_ui$Element$image,
						_List_Nil,
						{description: 'spinner', src: '/static/spinner.png'})
					]);
			} else {
				var _v0 = model.initialPoint;
				if (_v0.$ === 'Nothing') {
					return _List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Please write a valid formula to be able to fill in the initial values')
						]);
				} else {
					var point = _v0.a;
					return A2(
						...
						function (v) {
							return A2(
								...
								_List_fromArray(
									[
										$author$project$Main$inputValue(v)
									]));
						},
						point);
				}
...
var $author$project$Main$FormulaChanged = function (a) {
	return {$: 'FormulaChanged', a: a};
};
...
var $author$project$Main$defaultPlaceholder = '';
var $mdgriffith$elm_ui$Element$Input$Placeholder = F2(
	function (a, b) {
		return {$: 'Placeholder', a: a, b: b};
	});
var $mdgriffith$elm_ui$Element$Input$placeholder = $mdgriffith$elm_ui$Element$Input$Placeholder;
var $author$project$Main$placeholder = function (model) {
	return $elm$core$Maybe$Just(
		A2(
			...
			$mdgriffith$elm_ui$Element$text(
				function () {
					var _v0 = model.formula;
					if (_v0.$ === 'Nothing') {
						return $author$project$Main$defaultPlaceholder;
					} else {
						var f = _v0.a;
						return '';
					}
...
var $author$project$Main$inputFormula = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
			...
			[
					...
					]),
				{
					label: A2(
						...
						$mdgriffith$elm_ui$Element$text('Enter your formula:')),
					onChange: $author$project$Main$FormulaChanged,
					placeholder: $author$project$Main$placeholder(model),
					text: A2($elm$core$Maybe$withDefault, '', model.formula)
				})
			]));
};
...
var $author$project$Main$displayValue = function (_var) {
	var name = _var.a;
	var value = _var.b;
	return $mdgriffith$elm_ui$Element$text(name + (' = ' + value));
};
var $mdgriffith$elm_ui$Internal$Model$Empty = {$: 'Empty'};
var $mdgriffith$elm_ui$Element$none = $mdgriffith$elm_ui$Internal$Model$Empty;
var $author$project$Main$nearestPoint = function (model) {
	var _v0 = model.initialPoint;
	if (_v0.$ === 'Nothing') {
		...
		return A2(
			...
			function () {
				if ($author$project$Main$isFilled(
					$elm$core$Maybe$Just(initPoint))) {
					var _v1 = model.spinner;
					if (!_v1) {
						var _v2 = model.nearestPoint;
						if (_v2.$ === 'Just') {
							var p = _v2.a;
							return _Utils_ap(
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text('The nearest solution is')
									]),
								A2(
									$elm$core$List$map,
									function (v) {
										return A2(
											...
											_List_fromArray(
												[
													$author$project$Main$displayValue(v)
												]));
									},
									p));
						} else {
					...
					return _List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Fill in the initial values to compute the nearest solution')
						]);
				}
			}());
	}
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color(
				A3($mdgriffith$elm_ui$Element$rgb255, 42, 44, 43)),
				$mdgriffith$elm_ui$Element$Font$color(
				A3($mdgriffith$elm_ui$Element$rgb255, 217, 203, 158)),
				$mdgriffith$elm_ui$Element$paddingEach(
				{bottom: 100, left: 0, right: 0, top: 100})
			]),
		A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$author$project$Main$inputFormula(model),
					$author$project$Main$initialPoint(model),
					$author$project$Main$nearestPoint(model)
				])));
};
