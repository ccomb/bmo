...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{formula: $elm$core$Maybe$Nothing, initial_point: _List_Nil, nearest_solution: $elm$core$Maybe$Nothing},
...
var $author$project$Main$extractVariables = function (formula) {
	return A2(
		$elm$core$List$map,
		function (w) {
			return A2($author$project$Main$Variable, w, $elm$core$Maybe$Nothing);
		},
		$elm$core$Set$toList(
			A2(
				$elm$core$Set$remove,
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'FormulaChanged') {
			var formula = msg.a;
			var f = (!$elm$core$String$length(formula)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(formula);
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						formula: f,
						initial_point: $author$project$Main$extractVariables(formula)
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			var name = msg.a;
			...
			var newpoint = A2(
				...
				function (variable) {
					var n = variable.a;
					var v = variable.b;
					return _Utils_eq(name, n) ? A2(
						$author$project$Main$Variable,
						name,
						$elm$core$String$toFloat(value)) : variable;
				},
				model.initial_point);
			return _Utils_Tuple2(
				_Utils_update(
...
var $author$project$Main$defaultPlaceholder = '218*t*p*f - (p+s)*(b*1.38+12*n)+c = 0';
	...
	return A2(
			...
			]),
		{
			label: A2(
				...
				$mdgriffith$elm_ui$Element$text('Initial value for ' + (name + ' ='))),
...
var $author$project$Main$inputPoint = function (point) {
	return A2(
		$elm$core$List$map,
		function (v) {
			return A2(
	...
	return A2(
		...
		A2(
			...
			_Utils_ap(
				...
				$author$project$Main$inputPoint(model.initial_point))));
};
